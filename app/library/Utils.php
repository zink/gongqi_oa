...
class  Utils
{
    ...
    */
    ...
    public static function curl_client($url, $data=null, $method = 'GET' ,$is_string=false,$headers=[]){
        //TODO 接口认证
        //$headers[]='Authorization: FkJll3ddhiwx3Yq2ceVw';
        $opts = array(
            CURLOPT_TIMEOUT        => 30,
    ...
    public static function isMobile($string){
       return preg_match('/^1[3456789]{1}[0-9]{9}$/', $string) ? true :false;
    }
    ...
    static function is_wxapp() { // 微信小应用特殊头信息,仅限vmc 出品微信小应用有效
        if (isset($_SERVER['HTTP_X_REQUESTED_ISWXAPP']) && $_SERVER['HTTP_X_REQUESTED_ISWXAPP'] == 'YES') {
            return "WEIXIN";
        }
        if (isset($_SERVER['HTTP_X_REQUESTED_ISBDAPP']) && $_SERVER['HTTP_X_REQUESTED_ISBDAPP'] == 'YES') {
            return "BAIDU";
        }
        return false;
    }
